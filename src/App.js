  ...
  const sendGif = async () => {
    if (gifInputValue.length) {
      ...
      try {
        ...
        await program.rpc.addGif(gifInputValue, {
          accounts: {
            baseAccount: baseAccount.publicKey,
            user: provider.wallet.publicKey,
          },
        });
        console.log("GIF successfully sent to program", gifInputValue);

        await getGifList();
      } catch (error) {
        console.log("Error in sendGif: ", error);
      }
    } else {
      console.log("empty");
    }
    ...
    <div className="App">
      <div className={walletAddress ? "authed-container" : "container"}>
        <div className="header-container">
          <p className="header">🖼 GIF Arena</p>
          <p className="sub-text">
            View your GIF collection from Solana Blockchain! ✨
          </p>
